...
export default function SuccessContent() {
  ...
  const copyPix = () => {
    if (!pix) return;
    navigator.clipboard.writeText(decodeURIComponent(pix));
    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-zinc-400 mb-2">
          Pedido <strong className="text-white">#{orderId}</strong> criado com sucesso.
        </p>

        {pix && decodeURIComponent(pix) && (
        ...
        <div className="flex flex-col gap-3 mt-6">
          <Link href={`/conta/pedidos/${orderId}`} className="btn-outline">
            Ver meu pedido
          </Link>
